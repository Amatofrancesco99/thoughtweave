...
- [`skills/init-agents-file/references/antirez-commenting-philosophy.md`](../../skills/init-agents-file/references/antirez-commenting-philosophy.md) - Pre-loaded reference for the code documentation configurable area. Full article text from antirez.com/news/124. Referenced by the skill but loaded on demand, not fetched from web.
